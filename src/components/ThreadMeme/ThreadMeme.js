...
import "./ThreadMeme.css"

class ThreadMeme extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  render() {
    ...
    return(
      <div
        className="ThreadMeme"
        id={this.state.ThreadMemeId}
      ...
      >
        <section id="profilePic">
          ...
          >
            <ProfilePic account={this.state.author} id="ThreadMeme"/>
          </a>
        </section>
        <div id="ThreadMeme-body">
          <div id="ThreadMeme-header">
            <a
              href={`/${this.state.address.slice(1)}`}
              id="username"
              onClick={this.handleProfileClick}
          ...
          <div id="text-box">
            <p id="ThreadMeme-text">
              {this.state.visibleText}
            </p>
          </div>
          <div id="ThreadMeme-footer">
            <ReplyButton
